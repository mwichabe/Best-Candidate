                ...
                child: ListView.builder(
                  ...
                  DateFormat.yMMMd().format(createdAt.toDate());
                      return Container(
                        ...
                        child: Column(
                          children: [
                            Text('Hi $userNmae you have placed an order of developin an $orderType',style: const TextStyle(fontSize: 24),),
                            const Divider(
                              height: 10,
                            ),
                            Row(
                              children: [
                                ...
                                Card(
                                  elevation: 2.0,
                                  color: orderStatus=='Reviewing'? Colors.yellow : Colors.green,
                                  child: Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text(orderStatus,style: const TextStyle(fontWeight: FontWeight.bold),),
                                  ),
                                ),
                              ],
                            ),
                             ...
                             Row(
                              children: [
                                ...
                                Card(
                                  elevation: 2.0,
                                  color: paymentStatus=='Pending'? Colors.yellow : Colors.green,
                                  child: Padding(
                                    padding: const EdgeInsets.all(8.0),
                            ...
                            const Text('Order Informatin',style: TextStyle(fontWeight: FontWeight.w700,
                            fontSize: 18
                            ),),
                            const Divider(),
                            Row(
                              children: [
                                ...
                                child: Column(
                                  children: [
                                    const Text('Account Mail',style: TextStyle(
                                      fontSize: 18,
                              ...
                              Card(
                                child: Column(
                                  children: [
                                    const Text('Date of Creation ',style: TextStyle(
                                      fontSize: 18,
                                      fontWeight: FontWeight.w400
                                    ),),
                             ...
                             Padding(
                               ...
                               child: Card(
                                  child: Column(
                                    children: [
                                      const Text('Order Budget',style: TextStyle(
                                        fontSize: 18,
                                        fontWeight: FontWeight.w400
                                      ),),
